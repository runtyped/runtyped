...
test('complex union', () => {
    ...
    type EventTriggerMap = {
        ...
        ['chat-message-created']: EventTriggerPayloadBase<
    ...
    const payload2 = {
        ...
        'event': {
            'data':
                {
                    'new': {
                        'chat_id': 340, 'created_at': '2023-11-02T23:59:39.669998+00:00',
                        'id': 901, 'retry': 0, 'role': 'user', 'state': 'completed',
                        'text': 'hey', 'updated_at': '2023-11-02T23:59:39.669998+00:00'
                    },
                    'old': null
                },
            'op': 'INSERT', 'session_variables': {
                'x-hasura-organization-id': '1', 'x-hasura-role': 'user', 'x-hasura-user-id': '4'
            },

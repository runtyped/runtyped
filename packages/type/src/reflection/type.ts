...
// Re-export everything from type-annotations.ts so existing imports from reflection/type.ts continue to work
export * from '../type-annotations.js';
...
// Annotations type is now in type-annotations.ts

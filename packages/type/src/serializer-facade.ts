...
import { NamingStrategy, defaultNamingStrategy } from './serializer/naming.js';
import { HandlerRegistry } from './serializer/registry.js';
import {
    SerializeFunction,
    Serializer,
...
import { JsonBuildContext, SerializationOptions } from './serializer/state.js';
